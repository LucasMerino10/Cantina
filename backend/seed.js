...
const seed = async () => {
  try {
    ...
    await database.query(`INSERT INTO user (username, email, password_hash, avatar, color)
    ...
    await database.query(
      `INSERT INTO message (content, message_date, user_id)
                          VALUES(?, "2024-01-31 08:48:27", 1),
                                ...
                                (?, "2024-01-31 08:54:18", 2),
                                (?, "2024-01-31 08:56:27", 3),
                                (?, "2024-01-31 08:59:30", 2),
                                (?, "2024-01-31 09:17:59", 3),
                                (?, "2024-01-31 10:05:18", 1)`,
      [
